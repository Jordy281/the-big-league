"""
Welcome to the documentation for the Accounts API!
...
## Introduction
Accounts API is an easy to use web API for Seeder to manage all partners and their related advertising accounts. 

Accounts API provides the following features
- Partner CRUD (Create, Read, Update, Delete)
- DV360 CRUD
- CM360 CRUD
...
from api.app import create_app, db, ma,mongo  # noqa: F401